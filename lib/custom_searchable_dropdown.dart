...
class _CustomSearchableDropDownState extends State<CustomSearchableDropDown>
      ...
      children: [
        Stack(
          children: [
            ...
            SizeTransition(
                sizeFactor: _menuController, child: searchBox(setState))
          ],
        ),
  ...
  Widget _shoeMenuMode() {
    return SizeTransition(
        sizeFactor: _menuController, child: mainScreen(setState));
  }
        ...
        builder: (context) {
          return Padding(
            ...
            child: StatefulBuilder(builder: (context, setState) {
              return Material(
                  color: Colors.transparent, child: mainScreen(setState));
            }),
          );
        ...
        child: Column(
          ...
          children: [
            Visibility(
                ...
                child: Padding(
                  ...
                  child: Text(
                    ...
                    style: widget.labelStyle != null
                        ? widget.labelStyle!
                            .copyWith(color: widget.primaryColor ?? Colors.blue)
                        : TextStyle(color: widget.primaryColor ?? Colors.blue),
                  ),
                )),
            Visibility(
            ...
            (widget.menuMode ?? false)
                ? SizedBox(
                    height: widget.menuHeight ?? 150, child: mainList(setState))
